...
//       ctxt.drawImage(document.getElementById(originColor + '-gem'), originCol+timer*size/20, originRow, size, size);
//       ctxt.drawImage(document.getElementById(destColor + '-gem'), destCol-timer*size/20, destRow, size, size);
...
//       ctxt.drawImage(document.getElementById(originColor + '-gem'), originCol, originRow+timer*size/20, size, size);
//       ctxt.drawImage(document.getElementById(destColor + '-gem'), destCol, destRow-timer*size/20, size, size);
...
//   for(var i=0; i<crushList.length; {
//         for(var j=0; j<crushList[{
//     // console.log(gems);
//   }
//   }
// }
...
//   switch(color) {
//             case 'red':
//               ctx.drawImage(document.getElementById('red-gem'), col*size, row*size, gemWidth, gemHeight);
//               ctx.strokeRect(col*size, row*size, gemWidth, gemHeight);
//               break;
//             case 'green':
//               ctx.drawImage(document.getElementById('green-gem'), col*size, row*size, gemWidth, gemHeight);
//               ctx.strokeRect(col*size, row*size, gemWidth, gemHeight);
//               break;
//             case 'blue':
//               ctx.drawImage(document.getElementById('blue-gem'), col*size, row*size, gemWidth, gemHeight);
//               ctx.strokeRect(col*size, row*size, gemWidth, gemHeight);
//               break;
//             case 'orange':
//               ctx.drawImage(document.getElementById('orange-gem'), col*size, row*size, gemWidth, gemHeight);
//               ctx.strokeRect(col*size, row*size, gemWidth, gemHeight);
//               break;
//             case 'purple':
//               ctx.drawImage(document.getElementById('purple-gem'), col*size, row*size, gemWidth, gemHeight);
//               ctx.strokeRect(col*size, row*size, gemWidth, gemHeight);
//               break;
//             case 'yellow':
//               ctx.drawImage(document.getElementById('yellow-gem'), col*size, row*size, gemWidth, gemHeight);
//               ctx.strokeRect(col*size, row*size, gemWidth, gemHeight);
//               break;
//           }
// }
...
//     var loaded = false;
//     var counter = 0;
//     for( var i=0; i<imgToLoad.length; {
//         var img = new Image();
...
//     //             './graphics/red-gem.png', './graphics/red-special.png',
//     //             './graphics/yellow-gem.png', './graphics/color-bomb.png']);
...
//               break;
//           }
//           // ctx.drawImage(document.getElementById('green-gem'), row, col, (320/8), (320/8));
//           // ctx.drawImage(document.getElementById('orange-gem'),row, col, 20,10);
//       }
//     }
//   var canvas2 = document.getElementById('gemCanvas1');
